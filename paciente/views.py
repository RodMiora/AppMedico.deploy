...
def agendar_horario(request, id_data_aberta):
    if request.method == "GET":
        ...
        return redirect('/pacientes/minhas_consultas/') # Vai dar erro por enquanto não criamos essa URL
...
def cancelar_consulta(request, id_consulta):
    ...
    if request.user != consulta.paciente:
        messages.add_message(request, constants.ERROR, 'Essa consulta não pe sua!')
